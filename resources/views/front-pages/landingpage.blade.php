...
<html
  ...
  <head>
    ...
    <title>Home - Page | NexGenbot Hospital</title>
        ...
        <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
          ...
          <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto">
              ...
              <li class="nav-item">
                <a class="nav-link fw-medium" href="/home#landingFeatures">Features</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fw-medium" href="/home#landingTeam">Team</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fw-medium" href="/home#landingFAQ">FAQ</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fw-medium" href="/home#landingContact">Contact us</a>
              </li>
          ...
          <div class="container">
            <div class="hero-text-box text-center position-relative">
              <h1 class="text-primary hero-title display-6 fw-extrabold">
                Welcome to NexGenbot Hospital Service and Management System
              </h1>
              <h2 class="hero-sub-title h6 mb-6">
                Your healing and comfort is our vision and priority<br class="d-none d-lg-block" />
                enjoy exploring the features we provide.
              </h2>
            </div>
