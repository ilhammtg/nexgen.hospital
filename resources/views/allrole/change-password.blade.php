    ...
    <div class="card mb-6">
        ...
        <div class="card-body pt-1">
            <div class="card-body pt-4">
                <form id="formAccountSettings" method="POST" action="{{ route('users.changePassword') }}">
                    @csrf
                    @method('PUT')
                    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-7 order-md-1 order-0">
                <div class="text-center mt-4 mx-3 mx-md-0">
                    <img src="../../assets/img/illustrations/girl-with-laptop.png" class="img-fluid" alt="Api Key Image"
                        width="202" />
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-truncate text-heading fw-medium">
                                <i class="ti ti-brand-android ti-md align-top text-success me-2"></i>Chrome on
                                Android
                            </td>
                        ...
                        <tr>
                            <td class="text-truncate text-heading fw-medium">
                                <i class="ti ti-brand-windows ti-md align-top text-warning me-2"></i>Chrome on
                                Windows
                            </td>
                            <td class="text-truncate">HP Spectre 360</td>
                            <td class="text-truncate">Switzerland</td>
